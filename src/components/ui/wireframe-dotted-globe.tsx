...
export default function RotatingEarth({ width = 800, height = 600, className = "" }: RotatingEarthProps) {
  ...
  return (
    <div className={`relative ${className}`}>
      {isLoading && (
        <div className="absolute inset-0 flex items-center justify-center bg-black/50 backdrop-blur-sm z-10 rounded-2xl">
          <div className="text-center flex flex-col items-center gap-3">
            ...
            <span className="text-xs text-zinc-400 font-mono">Generating halftone vector mesh...</span>
          </div>
        </div>
      )}
      <canvas
      ...
      />
      <div className="absolute bottom-4 left-4 text-xs text-muted-foreground px-2 py-1 rounded-md dark bg-neutral-900/80 backdrop-blur-sm border border-zinc-800">
